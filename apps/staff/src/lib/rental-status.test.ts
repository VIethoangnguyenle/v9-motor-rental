...
const PICKUP_OVERDUE = "border border-status-overdue bg-status-overdue-soft text-status-overdue";
...
const CANCELLED = "border border-status-completed bg-status-completed-soft text-status-completed";
